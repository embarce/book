...
public interface GoodsDao {
     ...
     * @return
     */
    int deleteGoods(List<String> listCode,@Param("goodId") String userId);
     ...
     * @return
     */
    int updateGoodsUpper(List<String> listCode,@Param("goodId") String userId);
    /**
     * 下架商品
     * @author 7293747
     * @Date 2020-3-25
     ...
     * @return
     */
    int updateGoodsLower(List<String> listCode,@Param("goodId") String userId);
